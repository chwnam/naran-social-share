<?php
/**
 * NSS: AJAX (admin-ajax.php, or wc-ajax) reg.
 */
...
if ( ! class_exists( 'NSS_Reg_Ajax' ) ) {
	class NSS_Reg_Ajax implements NSS_Reg {
		/** @var string */
		 ...
		 * @param int|null             $priority     Priority number. Defaults to NSS_PRIORITY.
		 */
		public function __construct(
			...
			$this->priority     = is_null( $priority ) ? nss()->get_priority() : $priority;
		}
