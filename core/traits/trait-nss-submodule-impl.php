...
if ( ! trait_exists( 'NSS_Submodule_Impl' ) ) {
	trait NSS_Submodule_Impl {
		...
		protected function assign_modules( array $modules ): self {
			$cps = nss()->get_constructor_params();
